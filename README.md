...
Parsisiuskite .cpp ir .h failus iš pagrindinio folderio(nereikia test ir doxygen folderių)

# Programos naudojimas

1. Atsidarykite folderį su source failais terminale

2. Įveskite į terminalą make

3. Įveskite į terminalą ./programa

Sekite instrukcija ekrane.

Jei norite nuskaityti iš savo failo, pavadinkite jį kursiokai.txt ir įveskite duomenis tokiu formatu:

Vardas Pavarde Pažimys2 Pažimys1 EgzaminoĮvertinimas
